...
HELM_VER="3.15.4"; curl -L "https://get.helm.sh/helm-v${HELM_VER}-$(uname -s | tr [:upper:] [:lower:])-$(uname -m).tar.gz" | tar zxf - --strip-components 1 $(uname -s | tr [:upper:] [:lower:])-$(uname -m)/helm
